    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              onPressed: () {
                Navigator.pushReplacementNamed(context, HomeScree.routeName);
              },
              icon: const Icon(
                Icons.home,
                color: AppColors.primaryColor,
                    ...
                    child: Row(
                      children: [
                        InkWell(
                            ...
                            child: Icon(
                              productCounter == 0 ? Icons.remove_circle : Icons.remove_circle_outline,
                              size: 20.w,
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              setState(() {
                                selectedSize = index;
                                String updatedProduct = widget.product.selectedColor?? '';
                                updatedProduct= colorNames[index];
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text('EGP ${widget.product.price}', style: AppStyles.medium18Header)
                    ],
                  ),
                  SizedBox(
                    width: 33.w,
